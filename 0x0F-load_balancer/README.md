...
[1-install_load_balancer](./1-install_load_balancer) | Nash script configuring a brand new Ubuntu server and adds HAproxy with version equal or greater than 1.5
